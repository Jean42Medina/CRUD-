...
<body>
    <div class="container">
        <nav class="navbar navbar-dark bg-dark">
            <div class="container">
                <a href="index.php" class="navbar-brand">PHP postgres CRUD</a>
            </div>
        </nav>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $dato->dirrecion ?></td>
                                <td><?php echo $dato->telefono ?></td>
                                <td>
                                    <a href="update.php?id=<?php echo $dato->id?>" class="btn btn-secondary">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="delete.php?id=<?php echo $dato->id?>" class="btn btn-danger">
